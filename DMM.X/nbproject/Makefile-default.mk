...
FINAL_IMAGE=${DISTDIR}/DMM.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=ECU_layer/lcd/lcd.c MCAL_layer/adc/adc.c MCAL_layer/GPIO/hel_gpio.c MCAL_layer/interrupt/external_interrupt.c MCAL_layer/interrupt/interrupt_manager.c MCAL_layer/interrupt/internal_interrupt.c MCAL_layer/device_config.c main.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/ECU_layer/lcd/lcd.p1 ${OBJECTDIR}/MCAL_layer/adc/adc.p1 ${OBJECTDIR}/MCAL_layer/GPIO/hel_gpio.p1 ${OBJECTDIR}/MCAL_layer/interrupt/external_interrupt.p1 ${OBJECTDIR}/MCAL_layer/interrupt/interrupt_manager.p1 ${OBJECTDIR}/MCAL_layer/interrupt/internal_interrupt.p1 ${OBJECTDIR}/MCAL_layer/device_config.p1 ${OBJECTDIR}/main.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/ECU_layer/lcd/lcd.p1.d ${OBJECTDIR}/MCAL_layer/adc/adc.p1.d ${OBJECTDIR}/MCAL_layer/GPIO/hel_gpio.p1.d ${OBJECTDIR}/MCAL_layer/interrupt/external_interrupt.p1.d ${OBJECTDIR}/MCAL_layer/interrupt/interrupt_manager.p1.d ${OBJECTDIR}/MCAL_layer/interrupt/internal_interrupt.p1.d ${OBJECTDIR}/MCAL_layer/device_config.p1.d ${OBJECTDIR}/main.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/ECU_layer/lcd/lcd.p1 ${OBJECTDIR}/MCAL_layer/adc/adc.p1 ${OBJECTDIR}/MCAL_layer/GPIO/hel_gpio.p1 ${OBJECTDIR}/MCAL_layer/interrupt/external_interrupt.p1 ${OBJECTDIR}/MCAL_layer/interrupt/interrupt_manager.p1 ${OBJECTDIR}/MCAL_layer/interrupt/internal_interrupt.p1 ${OBJECTDIR}/MCAL_layer/device_config.p1 ${OBJECTDIR}/main.p1

# Source Files
SOURCEFILES=ECU_layer/lcd/lcd.c MCAL_layer/adc/adc.c MCAL_layer/GPIO/hel_gpio.c MCAL_layer/interrupt/external_interrupt.c MCAL_layer/interrupt/interrupt_manager.c MCAL_layer/interrupt/internal_interrupt.c MCAL_layer/device_config.c main.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/DMM.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/DMM.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/DMM.X.${IMAGE_TYPE}.map  -D__DEBUG=1  -mdebugger=none  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mno-default-config-bits -std=c99 -gcoff -mstack=compiled:auto:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/DMM.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} ${DISTDIR}/DMM.X.${IMAGE_TYPE}.hex 
	
else
${DISTDIR}/DMM.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/DMM.X.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mno-default-config-bits -std=c99 -gcoff -mstack=compiled:auto:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/DMM.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
